    ...
    <nav className="text-white  sticky top-1 z-50">
      ...
      <div className="max-w-7xl mx-auto px-4 flex items-center justify-between h-16">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <Link to="/auth"
            className="h-8 px-3 border border-white/20 text-gray-300 text-xs tracking-widest uppercase 
          hover:border-[#FF2E7E] hover:text-white transition duration-300 flex items-center">
            SIGN IN
          </Link>

          <Link to="/report-item"
            className="h-8 px-3 bg-[#FF2E7E] text-black text-xs font-bold tracking-widest uppercase 
      ...
      {open && (
        <div className="md:hidden px-4 pb-4 space-y-2">
          ...
          <button className="w-full mt-2 h-8 border border-white/20 text-gray-300 text-xs uppercase">
            SIGN IN
          </button>

          <Link to="/report-item" className="block w-full mt-2 h-8 bg-[#FF2E7E] text-black text-xs font-bold uppercase flex items-center justify-center">
            REPORT ITEM
          </Link>
